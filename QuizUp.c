...
int userlogin()
	...
	{	if( strcmp ( User->username, name) == 0)
		...
		else printf("Incorrect Username\n");}
    break;}
    }
    fclose(fp);
    }
...
float score;
userlogin ( );
if (userlogin) goto mainhome;
else printf ("Incorrect login credentials.");
mainhome:
fflush(stdin);
system("cls");
printf("HI");
...
{	system("cls");
	...
	printf("\t\t<>For each right answer chosen, you win an amount of $1000.\n");
	printf("\t\t<>For each wrong answer chosen, you lose an amount of $500.\n");
	...
	{n=rand()%10-1+7%2;
     ...
     if(n==0){printf("\nQuestion - What is the name of the group of animals which are active during twilight?\na) Diurnal\n");
              printf("b) Crepuscular\nc) Matutinal\nd) Vespertine\n");
	 scanf("%c",&x);
     x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is b)Crepuscular.");getc(stdin);};}

     if(n==1){printf("\nQuestion - This nut can be sweet or bitter and its oil is used in cosmetics, aromatherapy and in ");
              printf("making marzipan. USA is the top producer of it.\na) Pine nut\nb) Groundnut\nc) Cashew nut\nd) Almond\n");
	 scanf("%c",&x);
     x=tolower(x);
                if (x=='d'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is d)Almond.");getc(stdin);};}

     if(n==2){printf("\nQuestion - These crustaceans or animals with hard shells are called decapods, which means they have");
              printf(" 10 legs. The one pair of legs have enlarged pincers which help them grasp and tear their food. Which");
              printf(" of the following is a decapod?\na) Grasshopper\nb) Lobster\nc) Spider\nd) Octopus\n");
     scanf("%c",&x);
     x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==3){printf("\nQuestion - Which of the following statements is incorrect?\na) Photochemical smog always contains ozone");
              printf("\nb) Forests are called green lungs because they maintain the balance between oxygen and carbon dioxide ");
              printf("in the atmosphere.\nc) Lead is the most hazardous metal pollutant of automobile dust.\nd) None of these\n");
     scanf("%c",&x);
	 x=tolower(x);
                if (x=='d'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is d)None of these.");getc(stdin);};}

     if(n==4){printf("\nQuestion - Which of the following movements is taking place in Odisha where fertile land is being taken");
              printf(" for missile testing?\na) Baliapal movement\nb) Chipko movement\nc) Bishnoi movement\nd) Appiko movement\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='a'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is a)Baliapal movement.");getc(stdin);};}

     if(n==5){printf("\nQuestion - The Antarctic treaty states that \na) The continent should be used for scientific research ");
              printf("only.\nb) The continent be used for tourist purpose only.\nc) No person can live on Antarctica.\nd) Only");
              printf(" wild tribes are free to live on the continent.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='a'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is a)the continent should be used for scientific research only.");
                    getc(stdin);};}
	...
	{n=rand()%10-1+7%2;
     ...
     if(n==3){printf("\nQuestion - Jaya: How was the function yesterday?\nRati:________\na) That is a strange question\n");
              printf("b) Great! We had a ball dance.\nc) You shouldn’t worry about it\nd) Take it easy\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==6){printf("\nQuestion - Convert the following sentence to passive voice from active voice.\nThe doctor said to the ");
              printf("patient, “Take this medicine twice daily”.\na)The doctor advised the patient to take that medicine twice");
              printf(" daily.\nb)The doctor wished the patient took this medicine twice daily.\nc)The doctor told the patient to");
              printf(" taken this medicine twice daily.\nd)The doctor told the patient take this medicine twice daily.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='d'){printf("\n\nCorrect!!!");count++;getc(stdin);}
    ...
    {n=rand()%10-1+7%2;
     ...
     if(n==0){printf("\nQuestion - Which of the following is not the correct difference between weaving and knitting?\n");
              printf("(a)  Weaving is done by machine while knitting is done by hands only.\n(b)  Weaving uses one yarn ");
              printf("while knitting uses two sets of yarn.\n(c)  Weaving is done for silk only while knitting is done for");
              printf(" wool only.\n(d)  All of these.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='d'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==2){printf("\nQuestion - Read the given statements and select the correct one.\n(a)  There are total 10 pairs of");
              printf("ribs in human body.\n(b)  First seven pairs of ribs are called true ribs.\n(c)  Ribs are attached to ");
              printf("backbone in the front and to sternum at the back.\n(d)  Ribs protect the brain and the heart.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (b)	 First seven pairs of ribs are called true ribs.");
                getc(stdin);};}

     if(n==3){printf("\nQuestion - Which of the following is a correct match?\n(a)  Waste from farmyards and food courts –");
              printf("Non-biodegradable waste\n(b)  Pesticides, pharmaceuticals and heavymetal sludge – Biodegradable ");
              printf("waste \n(c)  Peels of fruits and vegetables, tea leaves – Organic waste\n(d)  Mineral wastes from ");
              printf("mining and rubber waste – Kitchen waste\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='c'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (c)	 Peels of fruits and vegetables, tea leaves – Organic ");
                    printf("waste.");getc(stdin);};}

     if(n==4){printf("\nQuestion - Manisha took some vinegar in a test tube and added some baking soda to it.  Then she lit a ");
              printf("matchstick and brought it near the mouth of the test tube.  The flame of matchstick got extinguished.  ");
              printf("Which of the following is correct conclusion regarding the given experiment?\n(a)  Carbon dioxide gas ");
              printf("does not support burning.\n(b)  Air contains carbon dioxide.\n(c)  Oxygen gas present in the air is ");
              printf("necessary for burning.\n(d)  Oxygen gas extinguish fire.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='a'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (a)	 Carbon dioxide gas does not support burning.");
                    getc(stdin);};}

     if(n==5){printf("\nQuestion - In circular motion, the\n(a)  Direction of motion is fixed.\n(b)  Direction of motion ");
              printf("changes continuously.\n(c)  At every point distance and displacement of the object moving is same.\n ");
              printf("(d)  Velocity is constant.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==7){printf("\nQuestion - Nisha placed a stick vertically in the playground at 8:15 am in the morning.  How will ");
              printf("the shadow of the stick at 12:00 noon be in comparison to the one at 8:15 	am?\n(a)  It will be ");
              printf("shorter than one at 8:15 am.\n(b)  It will be same as one at 8:15 am.\n(c)	 It will be greater than one");
     ...
     if(n==8){printf("\nQuestion - Mark the incorrect statement:\n(a)  Melting of wax is a physical change while burning of ");
              printf("wax in a candle is a chemical change.\n(b)  Metals expand on heating while contract on cooling.  Both ");
              printf("are physical changes.\n(c)	 Composition of matter 	changes during a chemical change while it remains ");
              printf("same during a physical change.\n(d)  High and low tides in sea are the examples of non-periodic changes ");
              printf("while growth of a tree is a periodic change.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='d'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (d)	 High and low tides in sea are the examples of non-periodic");
                     printf("changes while growth of a tree is a periodic change.");getc(stdin);};}

     if(n==9){printf("\nQuestion - Nitu mixed some iron filings with sulphur powder in a China dish. She heated the contents ");
              printf("of China dish.  What did she observe during the experiment?\n(a)  There was no difference in the contents");
              printf("of China dish before and after heating.\n(b)	 Before heating, iron filings and sulphur powder could be");
              printf("seen separately but after heating the contents became black.\n(c)  Before heating, the iron filings and");
              printf("sulphur powder could not be seen separately.\n(d)  Before heating, the contents were black and after ");
              printf("heating, iron filings and sulphur could be seen separately.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (b)	 Before heating, iron filings and sulphur powder could be");
                     printf("seen separately but after heating the contents became black.");getc(stdin);};}
	}
    ...
    {n=rand()%10-1+7%2;
     ...
     if(n==0){printf("\nQuestion - Which of the following options is incorrect?\n(a)	Roman numeral for the largest 3-digit ");
              printf("number is CMxCIx.\n(b)  The smallest 4-digit number formed by using the digits 5, 6, 0, 9 (using each ");
              printf("digit only once) is 5069.\n(c)  Estimated product of 5034 and 295 is 1500000.\n(d)  Place value and face");
              printf(" value are always equal at tens place.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='d'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==1){printf("\nQuestion - Study the given statements carefully and select the correct option:\nStatement 1: 7456824 ");
              printf("is divisible by 9.\nStatement 2: A natural number is divisible by 9, if the sum of the digits of the ");
              printf("number is divisible by 3.\n(a)  Both Statement 1 and Statement 2 are true.\n(b)  Both Statement 1 and ");
              printf("Statement 2 are false.\n(c)  Statement 1 is true but Statement 2 is false.\n(d)  Statement 1 is false ");
              printf("but Statement 2 is true.\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='c'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (c)	Statement 1 is true but Statement 2 is false.");getc(stdin);};}

     if(n==2){printf("\nQuestion - Arjun weighs twice as Surbhi and Sejal weighs 5kg less than Arjun.  If the total weight of");
              printf(" Arjun, Surbhi and SEjal is 63kg, then find the total weight of Sejal and Arjun.\n(a)  54.2 kg\n(b)  47 kg");
              printf("\n(c)  49.4 kg\n(d)  62.4 kg\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='c'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==3){printf("\nQuestion - Divide ₹3010 among A, B, C respectively in such a way that A gets double of what B gets ");
              printf("and B gets double of what C gets.\n(a)  ₹ 1720, ₹ 860, ₹ 430\n(b)  ₹ 1640, ₹ 920, ₹ 450\n");
              printf("(c)  ₹ 1690, ₹ 825, ₹ 495\n(d)  ₹ 1800, ₹ 400, ₹ 810\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='a'){printf("\n\nCorrect!!!");count++;getc(stdin);}
     ...
     if(n==5){printf("\nQuestion - The number of paving stones each measuring 10 dm by 9 dm required to pave a rectangular ");
              printf("veranda 60 m by 6 m is ______.\n(a)  360\n(b)  400\n(c)  350\n(d)  300\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='b'){printf("\n\nCorrect!!!");count++;getc(stdin);}
                else{printf("\n\nWrong!!! The correct answer is (b)	 400.");getc(stdin);};}

     if(n==6){printf("\nQuestion - If side of a square is doubled, then the new perimeter is ___________ times the original ");
              printf("perimeter.\n(a)  Two \n(b)  One- fourth\n(c)  Nine\n(d)  Four\n");
	 scanf("%c",&x);
	 x=tolower(x);
                if (x=='a'){printf("\n\nCorrect!!!");count++;getc(stdin);}
